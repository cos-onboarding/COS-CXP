...
create table tags (
	...
	upperName GENERATED ALWAYS AS (UPPER(name)),
	primary key (id)
);
...
create table items (
	...
	id bigint not null,
	contextItemName nvarchar(255) not null,
    ...
    publicationStatus nvarchar(255) not null,
    nextPublishAction nvarchar(255) default null,
