...
bd.uiEditingOptions = {
    ...
    */
    ...
    configStylesSet : {
        bbTemplate: {
            contentCss : '$(contextRoot)/static/backbase.com.2011.ice/css/ice-ckeditorContent.css',
            styleSet : [
     ...
     * live: https://my.backbase.com/docs/product-documentation/documentation/portal
     * test: https://docs.backbase.com/dev/portal
    ...
    backbaseDocumentation: {
        baseDocUrl: "https://community.backbase.com/documentation/portal",
        docVersionJoined: "573",
        docVersion: "5-7-3"
    }
