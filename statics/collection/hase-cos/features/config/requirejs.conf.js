...
(function(root, factory) {
    ...
    var config = {
        ...
        paths: {
			...
			'angular-ui-router'  	  : [ path + '/angular-ui-router/angular-ui-router' ],
            // LP foundation
			...
			'popper'          : path + '/popper/popper.min',
			'moment'          : path + '/moment/moment',
			'bootstrap'          : path + '/bootstrap/bootstrap.min',
			'bootstrap-table'          : path + '/bootstrap-table/bootstrap-table.min',
			'angular-moment-picker'          : path + '/angular-moment-picker/angular-moment-picker.min',
